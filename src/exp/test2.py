...
if __name__ == "__main__":
    ...
    for testfile in files:
        try:
            ...
            if testprofile == 'M':
                m_pred_all = np.concatenate([m_pred_all, pred])
                m_true_all = np.concatenate([m_true_all, y_test])
            else:
                f_pred_all = np.concatenate([f_pred_all, pred])
                f_true_all = np.concatenate([f_true_all, y_test])
    ...
    print("============= Results(MEN) =============")
    print("accuracy: ", round(accuracy_score(m_true_all, m_pred_all), 3))
    print("f1      : ", round(f1_score(m_true_all, m_pred_all), 3))

    print("============= Results(WOMEN) =============")
    print("accuracy: ", round(accuracy_score(f_true_all, f_pred_all), 3))
    print("f1      : ", round(f1_score(f_true_all, f_pred_all), 3))
