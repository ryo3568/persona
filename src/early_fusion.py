...
def main():
    ...
    for test_id in ids:
        ...
        model = FNN(input_dim=input_dim, output_dim=output_dim, modal=args.modal).to(device)
        ...
        evaluation(model, test_id, criterion=criterion, a_stds=train_dataset.a_stds, v_stds=train_dataset.v_stds)
